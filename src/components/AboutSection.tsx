...
import { Briefcase, Network, Shield, Globe } from 'lucide-react';
  ...
  const workExperience = [
    {
      ...
      description: [
        ...
        "Configured and troubleshooted routers/switches with RIP, OSPF, NAT, and DHCP",
      ...
      <section id="about" ref={sectionRef} className={`min-h-screen py-20 relative transition-all duration-700 opacity-0 translate-y-10 ${isResumeOpen ? 'blur-sm' : ''}`}>
        <div className="container mx-auto px-6">
          <h2 className="text-center mb-16 text-4xl font-bold tracking-tight">
            I AM A <span className="text-portfolio-teal">SOFTWARE ENGINEER</span>
          </h2>
                ...
                >
                  ...
                  <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 md:pr-12 text-right' : 'pl-8 md:pl-12'}`}>
                    <div className={`flex flex-col ${index % 2 === 0 ? 'items-end' : 'items-start'}`}>
                      ...
                      <ul className={`text-white/70 text-sm md:text-base ${index % 2 === 0 ? 'text-right' : 'text-left'} list-disc list-inside`}>
